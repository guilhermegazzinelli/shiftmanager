...
class ColaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colaborator" do
    assert_difference('Colaborator.count') do
      post colaborators_url, params: { colaborator: { area: @colaborator.area, company_number: @colaborator.company_number, email: @colaborator.email, name: @colaborator.name, operation_id: @colaborator.operation_id, personal_number: @colaborator.personal_number } }
    end
  ...
  test "should update colaborator" do
    patch colaborator_url(@colaborator), params: { colaborator: { area: @colaborator.area, company_number: @colaborator.company_number, email: @colaborator.email, name: @colaborator.name, operation_id: @colaborator.operation_id, personal_number: @colaborator.personal_number } }
